...
import EvaluateStyle from './EvaluateStyle';
...
class ConsultativeEvaluation extends React.PureComponent {
...
export default connect(mapStateToProps, mapDispatchToProps)(ConsultativeEvaluation);
