...
class SummaryReadOnly extends React.PureComponent {
	...
	render()
	{
		...
		if(progress && progress.right === LoadProgressConst.SAVING_FAILED)
		{
		...
		return (
			<div className='summary'>
				<div className='summary-container'>
					<div className='summary-tree' style={this.state.display ? {width: '1.95rem'} : {width: '0.05rem'}}>
						{
							this.state.display ?
								<div className="summary-type-box">
									...
									<SummaryTypeTreeReadOnly rootid={rootid} summaryTypeTree={summaryTypeTree}
					...
					>
						<SummaryListReadOnly selectedSummaryType={this.state.selectedSummaryType}
...
SummaryReadOnly = Form.create()(SummaryReadOnly);

export default connect(mapStateToProps, mapDispatchToProps)(SummaryReadOnly);
