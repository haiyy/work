...
import { formatTime, getLangTxt, loginUserProxy, shallowEqual } from "../../../utils/MyUtil";
...
export class ConsultInfoView extends React.Component {
    ...
    set _rosterUser(value) {
        if (value) {
            ...
            if (this.__rosterUser) {
                let userTrail = this.__rosterUser.userInfo.userTrail || {},
    ...
    getSecondLineUI()
    {
        let containerWidth = this.getContainer(); /*总容器的宽*/
                ...
                <div className="MessageStateLeft">
                    <div className="MessageStateIntro">
                        <p className="firstP">
                            ...
                            <span style={enabledForSelected(this._siteId) && this._userId ? {margin:'0 0.04rem'} : {}}>{enabledForSelected(this._siteId) && this._userId ? '|' : ''}</span>
